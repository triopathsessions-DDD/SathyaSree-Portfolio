				...
				<div className="grid w-full max-w-7xl items-center gap-12 lg:grid-cols-[55%_45%] lg:gap-14">
					...
					<div className="flex flex-col items-center text-center sm:items-start sm:text-left">
						...
						<p className="mt-4 max-w-xl text-base font-normal leading-relaxed text-charcoal/75 opacity-0 animate-fade-up animation-delay-300 dark:text-cream/70 md:text-lg">
							{/* {profile.tagline} */}
							I’m a fashion designer who works where creativity meets real-world
							execution — from developing concepts and collections to shaping
							how they are experienced in a retail space. I’m driven by strong
							visual storytelling, thoughtful details, and design that has a
							clear purpose.
						</p>
